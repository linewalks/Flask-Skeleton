...
from main.models.common import BaseTable
...
class Reply(BaseTable, db.Model):
  ...
  id = db.Column(db.Integer, db.ForeignKey(Board.id, ondelete="CASCADE"), nullable=True)
  board_id = db.Column(db.String(50), nullable=False) 
